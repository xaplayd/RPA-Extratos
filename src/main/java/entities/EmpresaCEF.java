...
public class EmpresaCEF {
	...
	public void geraExtratoCobranca() {
		...
		try {
			...
			s = new Screen();
			Pattern extratoCaixaBtn = archiveAdm.getPatternFromJar("/prints/cef/extratocaixa.png",0.6);
			Match mExtratoCaixa = s.wait(extratoCaixaBtn, 10);
			Location locExtratoCaixa = mExtratoCaixa.getTarget();
			robot.mouseMove(locExtratoCaixa.getX(), locExtratoCaixa.getY());
			Thread.sleep(300);
			robot.mousePress(InputEvent.BUTTON1_DOWN_MASK);
			robot.mouseRelease(InputEvent.BUTTON1_DOWN_MASK);
			Thread.sleep(3000);
			...
			s = new Screen();
			Pattern outroPeriodoBtn = archiveAdm.getPatternFromJar("/prints/cef/outroperiodo.png",0.6);
			Match mOutroPeriodo = s.wait(outroPeriodoBtn, 10);
			Location locOutroPeriodo = mOutroPeriodo.getTarget();
			robot.mouseMove(locOutroPeriodo.getX(), locOutroPeriodo.getY());
			Thread.sleep(300);
			robot.mousePress(InputEvent.BUTTON1_DOWN_MASK);
			robot.mouseRelease(InputEvent.BUTTON1_DOWN_MASK);
			Thread.sleep(3000);
			...
			s = new Screen();
			Pattern dataInicialBtn = archiveAdm.getPatternFromJar("/prints/cef/datainicial.png",0.6);
			Match mDataInicial = s.wait(dataInicialBtn, 10);
			Location locDataInicial = mDataInicial.getTarget();
			robot.mouseMove(locDataInicial.getX(), locDataInicial.getY());
			Thread.sleep(300);
			robot.mousePress(InputEvent.BUTTON1_DOWN_MASK);
			robot.mouseRelease(InputEvent.BUTTON1_DOWN_MASK);
			Thread.sleep(3000);
			...
			s = new Screen();
			Pattern exportarPdfBtn = archiveAdm.getPatternFromJar("/prints/cef/exportarpdf.png",0.6);
			Match mExportarPdf = s.wait(exportarPdfBtn, 10);
			Location locExportarPdf = mExportarPdf.getTarget();
			robot.mouseMove(locExportarPdf.getX(), locExportarPdf.getY());
			Thread.sleep(300);
			robot.mousePress(InputEvent.BUTTON1_DOWN_MASK);
			robot.mouseRelease(InputEvent.BUTTON1_DOWN_MASK);
			Thread.sleep(3000);
