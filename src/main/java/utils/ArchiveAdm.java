...
public class ArchiveAdm {
    ...
    public void salvarArquivoXP(String nomeArquivoSalvar, String caminhoSalvarPasta, LocalDate data) {
    ...
    public void salvarArquivoXPCapa(String nomeArquivoSalvar, String caminhoSalvarPasta, LocalDate data) {
		try {
